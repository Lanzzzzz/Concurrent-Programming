 ...
 * Sample solution.
 *
 * @version $Revision: 768 $ $Date: 2009-06-09 23:31:57 -0230 (Tue, 09 Jun 2009) $
 * @author Dennis Peters ($Author: dpeters $)
 *
 * $Id: assign2_q16b.java 768 2009-06-10 02:01:57Z dpeters $   
  *
 ******************************************************************/
package q16b;
...
class BroadcastBuffer {
  ...
  public BroadcastBuffer()
  {
    ...
    front = new int[assign2_q16b.NumCons];
    rear = 0;

    entry = new Semaphore(1);
    empty = new Semaphore(0);
    full = new Semaphore[NumBuf];
    ...
    throws InterruptedException
  {
    ...
    entry.acquire();
    numToRead[rear] = assign2_q16b.NumCons;
    rear = (rear + 1) % NumBuf;
    signal();
  }
 ...
 ******************************************************************/
  ...
  {
    int msg;
    for (int i = 0; i < assign2_q16b.NumMsg; i++) {
      try {
